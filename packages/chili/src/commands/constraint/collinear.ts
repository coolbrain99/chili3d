...
import { TransformedCommand } from "../modify/transformedCommand";

@command({
    name: "constraint.collinear",
    display: "command.collinear",
    icon: "icon-mirror",
})
export class Collinear extends TransformedCommand {
